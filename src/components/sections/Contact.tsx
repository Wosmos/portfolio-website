        ...
        <div className="glass-cosmic rounded-3xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-4 cosmic-glow">
                Let&apos;s Build Something
              </h2>
              <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                Ready to bring your ideas to life? Whether it&apos;s a
                cutting-edge web application, mobile app, or AI integration,
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      className="p-3 glass-cosmic rounded-full hover:bg-indigo-500/20 transition-all hover:scale-110"
                      aria-label="GitHub"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-3 glass-cosmic rounded-full hover:bg-blue-500/20 transition-all hover:scale-110"
                      aria-label="LinkedIn"
                    >
                      <Linkedin className="w-5 h-5" />
                    </a>
                    <a
                      href="https://www.instagram.com/wosmo_tech/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-3 glass-cosmic rounded-full hover:bg-pink-500/20 transition-all hover:scale-110"
                      aria-label="Instagram"
                    >
                      <Instagram className="w-5 h-5" />
                    </a>
                    <a
                      href="https://hashnode.com/@Wosmo"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-3 glass-cosmic rounded-full hover:bg-green-500/20 transition-all hover:scale-110"
                      aria-label="Hashnode"
                    >
              ...
              <form ref={formRef} className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full bg-black/30 border border-white/10 rounded-lg p-4 focus:outline-none focus:border-indigo-500 transition-colors text-white placeholder-gray-500"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    required
                    className="w-full bg-black/30 border border-white/10 rounded-lg p-4 focus:outline-none focus:border-indigo-500 transition-colors text-white placeholder-gray-500 resize-none"
