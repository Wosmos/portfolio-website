...
const Experience = () => {
  ...
  return (
    <section id="experience" ref={containerRef} className="py-24 px-4 md:px-6 relative overflow-hidden ">
                        ...
                        <div key={index} className={`relative flex flex-col md:flex-row items-start ${index % 2 === 0 ? 'md:flex-row-reverse' : ''} group`}>
                            ...
                            <div className="ml-12 md:ml-0 md:w-1/2 md:px-12 experience-card perspective-1000">
                                <div className="relative p-1 rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 group-hover:from-slate-700 group-hover:to-slate-800 transition-all duration-500 border border-slate-800 hover:border-slate-600 shadow-xl overflow-hidden">
                                    ...
                                    {/* Hover Glow Effect */}
                                    <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-gradient-to-r ${exp.gradient} blur-xl`} />
