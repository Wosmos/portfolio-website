  ...
  useGSAP(
    () => {
      ...
      const skillsContainer =
        containerRef.current?.querySelector(".skills-container");
      if (skillsContainer) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-2 lg:col-span-2 cosmic-card">
          ...
          <p className="text-gray-300 leading-relaxed mb-6">
            Software Engineering student passionate about bridging design and
            functionality. Crafting intuitive interfaces with{" "}
            <span className="text-cyan-400 font-semibold">React Native</span>{" "}
            and building robust backends with{" "}
        ...
        <div className="md:col-span-2 lg:col-span-2 cosmic-card">
          ...
          <div className="grid grid-cols-6 gap-3">
            <div className="glass-panel p-3 rounded-lg text-center group hover:bg-cyan-400/10 transition-all">
              ...
              <div className="text-xs text-gray-400 group-hover:text-cyan-400 font-mono">
                REACT
              </div>
            </div>
            <div className="glass-panel p-3 rounded-lg text-center group hover:bg-blue-400/10 transition-all">
              ...
              <div className="text-xs text-gray-400 group-hover:text-blue-400 font-mono">
                FLUTTER
              </div>
            </div>
            <div className="glass-panel p-3 rounded-lg text-center group hover:bg-green-400/10 transition-all">
              ...
              <div className="text-xs text-gray-400 group-hover:text-green-400 font-mono">
                NODE
              </div>
            </div>
            <div className="glass-panel p-3 rounded-lg text-center group hover:bg-purple-400/10 transition-all">
              ...
              <div className="text-xs text-gray-400 group-hover:text-purple-400 font-mono">
                AI
              </div>
            </div>
            <div className="glass-panel p-3 rounded-lg text-center group hover:bg-yellow-400/10 transition-all">
              ...
              <div className="text-xs text-gray-400 group-hover:text-yellow-400 font-mono">
                JS
              </div>
            </div>
            <div className="glass-panel p-3 rounded-lg text-center group hover:bg-cyan-400/10 transition-all">
        ...
        <div className="bento-card bento-large glass-cosmic p-6 relative overflow-hidden">
          ...
          <div className="space-y-4">
            <article className="glass-cosmic p-4 rounded-lg hover:bg-white/5 transition-colors cursor-pointer group">
              ...
              <h5 className="font-semibold group-hover:text-indigo-300 transition-colors">
                TypeScript: The Second Love
              </h5>
              <p className="text-sm text-gray-400 mt-1">
                Why transitioning from JS to TS is painful at first but
