...
import { X, Minus, Square, FileCode, Terminal as TerminalIcon, Play } from 'lucide-react';
...
const CodeTerminal = () => {
  ...
  return (
    <div ref={containerRef} className="relative group">
      ...
      <div className={`relative rounded-lg overflow-hidden bg-[#1e1e1e] border border-[#2d2d30] shadow-2xl transition-all duration-300 ${isMaximized ? 'scale-105' : ''}`}>
        ...
        <div className="flex items-center justify-between px-4 py-2 bg-[#323233] border-b border-[#2d2d30]">
          <div className="flex items-center gap-3">
            <div className="flex gap-2">
              <button 
                onClick={handleClose}
                className="w-3 h-3 rounded-full bg-[#ff5f57] hover:bg-[#ff3b30] transition-all duration-200 flex items-center justify-center group/btn"
              >
                <X className="w-2 h-2 text-[#4d0000] opacity-0 group-hover/btn:opacity-100 transition-opacity" />
              </button>
              <button 
                onClick={handleMinimize}
                className="w-3 h-3 rounded-full bg-[#febc2e] hover:bg-[#ffb300] transition-all duration-200 flex items-center justify-center group/btn"
              >
                <Minus className="w-2 h-2 text-[#4d3500] opacity-0 group-hover/btn:opacity-100 transition-opacity" />
              </button>
              <button 
                onClick={handleMaximize}
                className="w-3 h-3 rounded-full bg-[#28c840] hover:bg-[#1aab2a] transition-all duration-200 flex items-center justify-center group/btn"
              >
                <Square className="w-1.5 h-1.5 text-[#004d00] opacity-0 group-hover/btn:opacity-100 transition-opacity" />
              </button>
            </div>
            <span className="text-xs text-gray-400 font-medium">Visual Studio Code</span>
          </div>
          <div className="text-xs text-gray-500">wasif-portfolio</div>
        </div>
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 text-xs font-mono border-r border-[#2d2d30] transition-all duration-200 hover:bg-[#2d2d30] ${
                  activeTab === index ? 'bg-[#1e1e1e] text-white' : 'text-gray-400'
                }`}
              >
                <Icon className="w-3 h-3" />
                {tab.name}
                {tab.modified && <span className="w-1.5 h-1.5 rounded-full bg-cyan-400"></span>}
              </button>
            );
          })}
        </div>
        ...
        <div className="bg-[#1e1e1e] p-6  text-gray-300 min-h-[300px] overflow-x-auto">
          ...
          {activeTab === 0 && (
            <>
              <CodeLine num="1">
                <span className="text-[#c586c0]">const</span> <span className="text-[#4ec9b0]">Developer</span> <span className="text-white">=</span> <span className="text-[#ffd700]">{'{'}</span>
              </CodeLine>
              
              <CodeLine num="2">
                <span className="ml-4 text-[#9cdcfe]">name:</span> <span className="text-[#ce9178]">'Wasif Malik'</span>,
              </CodeLine>
          ...
          {activeTab === 1 && (
            <>
              <CodeLine num="1">
                <span className="text-[#6a9955]">// Technical Skills & Technologies</span>
              </CodeLine>
              
              <CodeLine num="2">
                <span className="text-[#c586c0]">type</span> <span className="text-[#4ec9b0]">TechStack</span> <span className="text-white">=</span> <span className="text-[#ffd700]">{'{'}</span>
              </CodeLine>
              
              <CodeLine num="3">
                <span className="ml-4 text-[#9cdcfe]">frontend:</span> <span className="text-[#4ec9b0]">string</span><span className="text-white">[]</span>;
              </CodeLine>
              
              <CodeLine num="4">
                <span className="ml-4 text-[#9cdcfe]">backend:</span> <span className="text-[#4ec9b0]">string</span><span className="text-white">[]</span>;
              </CodeLine>
              ...
              <CodeLine num="7" className="mt-2">
                <span className="text-[#c586c0]">const</span> <span className="text-[#4fc1ff]">skills</span><span className="text-white">:</span> <span className="text-[#4ec9b0]">TechStack</span> <span className="text-white">=</span> <span className="text-[#ffd700]">{'{'}</span>
              </CodeLine>

              <CodeLine num="8">
                <span className="ml-4 text-[#9cdcfe]">frontend:</span> <span className="text-white">[</span>
              </CodeLine>
              ...
              <CodeLine num="15" className="mt-2">
                <span className="text-[#c586c0]">export default</span> <span className="text-[#4fc1ff]">skills</span>;
              </CodeLine>
            </>
          )}
          ...
          {activeTab === 2 && (
            <>
              ...
              <CodeLine num="2">
                <span className="ml-4 text-[#9cdcfe]">"experience"</span><span className="text-white">:</span> <span className="text-white">[</span>
              </CodeLine>
              ...
              <CodeLine num="5">
                <span className="ml-12 text-[#9cdcfe]">"company"</span><span className="text-white">:</span> <span className="text-[#ce9178]">"Avialdo Solutions"</span>,
              </CodeLine>

              <CodeLine num="6">
                <span className="ml-12 text-[#9cdcfe]">"location"</span><span className="text-white">:</span> <span className="text-[#ce9178]">"Karachi"</span>,
              </CodeLine>

              <CodeLine num="7">
                <span className="ml-12 text-[#9cdcfe]">"period"</span><span className="text-white">:</span> <span className="text-[#ce9178]">"Jan 2025 - Present"</span>,
              </CodeLine>
